...
fn function(client: &mut Client, vector: &Vec<&str>,
			raw_defaults: Option<&(&str, &str, &str, &str)>) {
...
fn split_line(line: &str) -> (&str, &str) {
	...
	(&line[0..split_index], &line[split_index + 1..])
}


pub fn main(mut client: &mut Client, presets: &HashMap<&str, (&str, &str, &str, &str)>,
